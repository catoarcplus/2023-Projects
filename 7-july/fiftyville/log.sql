...
-- description of the crime check
SELECT description
...
-- Bruce must the thief as he is present in all the 4 lists- List of passengers.
-- He must have escaped to the New York City, as he took the New York City flight.
-- Robin purchased the flight ticket and helped Bruce escape.